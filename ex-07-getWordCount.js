...
function getWordCount(text) {
  //Convertimos nuestro texto en array para evaluar cada palabra
  ...
  //Creamos un for para iterar cada palabra
  for(var i = 0; i < newText.length; i++) {

    //Creamos condicionales , si cumple se le suma 1 a la propiedad respestiva del objeto
    if (newText[i].toLowerCase() === "be") {
      wordFrequencyObject.be += 1;
    } else if (newText[i].toLowerCase() === "need") {
      wordFrequencyObject.need += 1;
    } else if (newText[i].toLowerCase() === "you") {
      wordFrequencyObject.you += 1;
    } else if (newText[i].toLowerCase() === "not") {
      wordFrequencyObject.not += 1;
    } else if (newText[i].toLowerCase() === "only") {
      wordFrequencyObject.only += 1;
    } else if (newText[i].toLowerCase() === "in") {
      wordFrequencyObject.in += 1;
    }
  }
