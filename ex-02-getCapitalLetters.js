...
function getCapitalLetters(string) {
  ...
  //Creamos nuestra nueva array
  var newArray = [];

  //iteramos los elementos de la lista con las letras del string
  for(var i = 0; i < array.length; i++) {

    //Comparamos si son mayúsculas y diferentes de un espacio
    if (array[i] === array[i].toUpperCase() && array[i] !== " "){
